				...
				<splitpanes>
					<pane size="30">
						<div class="layout-padding-auto layout-padding-view">
							...
							<el-scrollbar>
								<query-tree ref="dictTreeRef" :query="state.queryList" @node-click="handleNodeClick"
											...
											<span class="do">
												<el-button-group>
													<el-button icon="Edit" size="small" type="primary"
														@click.stop="dicDialogRef.openDialog(data.id)"></el-button>
													<el-tooltip :content="$t('sysdict.deleteDisabledTip')" :disabled="data.systemFlag === '0'"
														placement="top">
														<span style="margin-left: 12px">
															<el-button :disabled="data.systemFlag !== '0'" icon="Delete" size="small" type="danger"
...
<style scoped>
.menu::v-deep(.el-tree-node__label) {
	display: flex;
	flex: 1;
	height: 100%;
}
