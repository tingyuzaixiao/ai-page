    ...
    <div class="layout-padding-auto layout-padding-view">
      ...
      <el-row>
        <div class="mb8" style="width: 100%;">
          ...
          <el-button :disabled="multiple" icon="Delete" type="primary" class="ml10" v-auth="'sys_file_del'" plain
      ...
      <el-table :data="state.dataList" v-loading="state.loading" style="width: 100%;"
        ...
        <el-table-column prop="md5" :label="t('file.md5')" show-overflow-tooltip />
        <el-table-column prop="baseDatasetId" :label="t('file.baseDatasetId')" show-overflow-tooltip />
        ...
        <el-table-column :label="$t('common.action')" width="200">
          <template #default="scope">
            <el-button icon="delete" text type="primary" v-auth="'sys_file_del'"
              @click="handleDelete([scope.row.id])">{{ $t("common.delBtn") }}</el-button>
            <el-button icon="download" type="primary" text @click="download(scope.row)">{{ $t("common.download")
            }}</el-button>
          </template>
        </el-table-column>
      </el-table>
