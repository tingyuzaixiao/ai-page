		...
		<div class="layout-padding-auto layout-padding-view">
				...
				<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList" ref="queryRef">
					...
					<el-form-item :label="$t('syslog.createTime')" prop="createTime">
						<el-date-picker :end-placeholder="$t('syslog.inputEndPlaceholderTip')"
							...
							v-model="state.queryForm.createTime" value-format="YYYY-MM-DD HH:mm:ss" />
					</el-form-item>
					<el-form-item>
			...
			<el-row>
				<div class="mb8" style="width: 100%">
					...
					<right-toolbar :export="'sys_log_export'" @exportExcel="exportExcel" @queryTable="getDataList" class="ml10"
