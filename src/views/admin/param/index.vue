		...
		<div class="layout-padding-auto layout-padding-view">
			<el-row class="ml10" v-show="showSearch">
				<el-form :inline="true" :model="state.queryForm" ref="queryRef">
					<el-form-item :label="$t('param.publicName')" prop="publicName">
						<el-input :placeholder="$t('param.inputpublicNameTip')" style="max-width: 180px"
							v-model="state.queryForm.publicName" />
					</el-form-item>
					<el-form-item :label="$t('param.publicKey')" prop="publicKey">
						<el-input :placeholder="$t('param.inputpublicKeyTip')" style="max-width: 180px"
							v-model="state.queryForm.publicKey" />
					</el-form-item>
			...
			<el-row>
				<div class="mb8" style="width: 100%">
					<el-button v-auth="'sys_syspublicparam_add'" @click="formDialogRef.openDialog()" class="ml10"
						icon="folder-add" type="primary">
						{{ $t('common.addBtn') }}
					</el-button>

					<el-button plain v-auth="'sys_syspublicparam_del'" @click="handleRefreshCache()" class="ml10"
						icon="refresh-left" type="primary">
						{{ $t('common.refreshCacheBtn') }}
					</el-button>

					<el-button plain v-auth="'sys_syspublicparam_del'" :disabled="multiple" @click="handleDelete(selectObjs)"
						class="ml10" icon="Delete" type="primary">
						{{ $t('common.delBtn') }}
					</el-button>

					<right-toolbar :export="'sys_syspublicparam_del'" @exportExcel="exportExcel" @queryTable="getDataList"
			...
			<el-table :data="state.dataList" @selection-change="handleSelectionChange" style="width: 100%"
				...
				<el-table-column :label="$t('common.action')" width="150">
					<template #default="scope">
						...
						<el-tooltip :content="$t('sysdict.deleteDisabledTip')" :disabled="scope.row.systemFlag === '0'"
							placement="top">
							<span style="margin-left: 12px">
								<el-button icon="delete" v-auth="'sys_syspublicparam_del'" :disabled="scope.row.systemFlag !== '0'"
