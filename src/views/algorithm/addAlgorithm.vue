<template>
  <el-dialog :title="dialogTitle" width="600" v-model="visible" :close-on-click-modal="false" draggable>
    <el-form ref="dataFormRef" :model="form" :rules="dataRules" label-width="110px" v-loading="loading">
      <el-form-item :label="t('algorithm.server')" prop="gpuName">
        <el-input v-model="form.gpuName" :placeholder="t('algorithm.algorithmServerInputTip')" />
      </el-form-item>
      <el-form-item :label="t('algorithm.description')" prop="gpuId">
        <el-input v-model="form.gpuId" :placeholder="t('algorithm.algorithmDescInputTip')" />
      </el-form-item>
      <el-form-item :label="t('algorithm.params')" prop="cardNum">
        <el-input v-model="form.cardNum" :placeholder="t('algorithm.algorithmParamsInputTip')" />
      </el-form-item>
    </el-form>
    <template #footer>
