  ...
  <el-dialog :title="t('labelGroup.labelGroupConfig')" width="500" v-model="visible" :close-on-click-modal="false"
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="primary" @click="onSubmit" :disabled="loading" v-auth="'sys_labelgroup_update_onsubmit'">{{
...
<script setup lang="ts" name="annotationDialog">
...
const dataRules = ref({
  groupName: [
    ...
    // 		validateLabelGroupName(rule, value, callback, form.groupId !== '');
    // 	},
    // 	trigger: 'blur',
    // },
  ],
